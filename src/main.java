...
public class main {
    public static void main(String[] args) throws IOException {
        String[] paths = {"//home//maork//Semester 5//Distributed Data Systems//Home Work//Distributed Data Systems Project//src/input_DEBUG.txt"}; //enter the path to the files you want to run here.
