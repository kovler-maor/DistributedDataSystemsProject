...
public class main {
    public static void main(String[] args) throws IOException {
        String[] paths = {"C:\\Users\\morzo\\OneDrive\\Documents\\Java technion\\JavaTechnion\\DistributedDataSystemsProject\\src\\input_DEBUG.txt"}; //enter the path to the files you want to run here.
